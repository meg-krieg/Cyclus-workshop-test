...
Once you have a GitHub account, and are signed in on [GitHub](https://github.com), visit the [Tutorial Repository](https://github.com/cyclus/Workshop-Codespace). From here, you will need to:
...
![Craete Fork](../img/Create-Fork.png)

2. Check that you are now on the GitHub page of your fork (the URL should have changed from https://github.com/cyclus/Workshop-Codespace to something like https://github.com/your-username/Workshop-Codespace). Once you are, press the green "Code" button:
...
3. Click the green "Create Codespace" button within the menu shown above to create a GitHub Codespace. This will place you in a VS Code development environent inside your browser with Cyclus pre-installed and configured. While it is loading, do not hit any buttons. It will take 2-3 minutes to fully initialize. During this initialization, it will look like this:
...
VS Code is a integrated development environment which boasts a variety of helpful plugins, and will be the editor we use for this tutorial. There are four main "panes" within VS code:
